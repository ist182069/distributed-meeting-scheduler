...
namespace MSDAD
{
    namespace Library
    {
        ...
        {
            int Hello(string client_identifier, string client_remoting, string client_ip, int client_port);
            void Ping(string message, string user);
            void Create(string meeting_topic, int min_attendees, List<string> slots, List<string> invitees, string client_identifier, string server_identifier, int hops, List<string> logs_list, int version);
            ...
            void Close(string meeting_topic, string client_identifier, string server_identifier, int hops, List<string> logs_list, int version);
